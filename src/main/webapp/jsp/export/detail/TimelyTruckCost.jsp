...
<script type="text/javascript">
	...
	$(function() {
		...
		tableWin.loadSearch(select, {
			tableId : 'myTable',
			formId : 'myForme',
			dataExport:{url:'timelytruckcost/exportData'
		...
		//初始化table
		myTable = tableWin.loadTable('myTable', 'timelytruckcost/query', eval(getval("fileds")), {
			sidePagination:'server',singleSelect : true,showColumns : true,showRefresh : true,pagination : true,showToggle :true
		});
	});
</script>
