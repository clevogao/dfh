...
$(function() {
	...
	tableWin.loadSearch(eval(getval("selects")), {
		tableId : 'myTable',
		formId : 'myForme',
		dataExport:{url:'truckuserreport/exportData'
	...
	$("#search_"+"truck_register_time"+"_str").val(newDate());
	$("#search_"+"truck_register_time"+"_end").val(newDate(1));
	//初始化table
	myTable = tableWin.loadTable('myTable', 'truckuserreport/query', eval(getval("fileds")), {
